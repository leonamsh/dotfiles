...
alias upp='~/scripts/arch/update.sh'
alias fupp='~/scripts/arch/full-update.sh'
alias limpao='~/scripts/arch/update-clean-arch.sh'
alias cdgit='cd /'
alias cdg='cd .config'
alias updspd='~/.config/autostart/xinputI3.sh'
alias srcfish='source ~/.config/fish/config.fish'
alias srczsh='source ~/.zshrc'
alias ffuu='~/scripts/arch/full-update.sh && ~/scripts/arch/update.sh && ~/.config/autostart/xinputI3.sh'
alias fupd='fupp && upp'
