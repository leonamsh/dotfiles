;;; eslint-rc-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
This is a minor mode.  If called interactively, toggle the `Eslint-RC
...
evaluate the variable `eslint-rc-mode'.
